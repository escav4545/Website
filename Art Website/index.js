...
var twentyNine = document.createDocumentFragment();
 ...
 function updateDays() {
   ...
   if (deliveryMonth.selectedIndex === -1) { // when the year is selected and there is no monthe it sets it to -1 and then ruins the rest of the code
     return;
   }
   var selectedMonth = deliveryMonth.options[deliveryMonth.selectedIndex].value;


   if (deliveryYear.selectedIndex === -1) { //  if year is not selected then set the vlaue to 0
     deliveryYear.selectedIndex = 0;
   }
   while (dates[28]) { //Gets rid if the 1-28 vlaues
 ...
 function coppyBillingAddress() { // coppies the billing address
   var billingInputElements = document.querySelectorAll("#billingAddress input");
   var deliveryInputElements = document.querySelectorAll("#deliveryAddress input");
   if (document.getElementById("sameAddr").checked) { //  checked - coppy data rom billing to delivery
 ...
 function createEventListeners() { // takes care of all event listners that are needed.
   ...
   var messageBox = document.getElementById("customMessage"); // adds event listner for the customtext
   if (messageBox.addEventListener) {
     messageBox.addEventListener("change", autoCheckCustom, false)
   } else if (messageBox.attachEvent) {
     messageBox.attachEvent("onchange", autoCheckCustom)
   }
   var sameAddress = document.getElementById("sameAddr"); //  adds event handler that coppies the billing address
   ...
   var showPasss = document.getElementById("Spass"); // 
   ...
   var validatePass = document.getElementById("Spass"); // 
